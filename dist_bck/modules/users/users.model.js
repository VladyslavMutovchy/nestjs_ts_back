...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'false', description: 'Забанен ли пользователь' }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.BOOLEAN, defaultValue: false }),
    __metadata("design:type", Boolean)
], User.prototype, "banned", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'использовал метод map внутри map', description: 'Причина бана' }),
